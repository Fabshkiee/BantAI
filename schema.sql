...
INSERT OR IGNORE INTO hazard_types (name, category, default_severity, description, recommendation) VALUES
    ...
    ('window_security_bar',     'fire',       'high',     'Window security bars or grilles may block escape routes in case of an emergency.', 'Ensure at least one window with security bars has a quick-release mechanism for emergency exits.'),
    ('curtain',                 'fire',       'medium',   'Curtains placed too close to heat sources or open flames can easily catch fire.', 'Keep curtains tied back and maintain a safe distance from stoves, heaters, or open flames.'),
    ('water_damage',            'structural', 'high',     'Signs of water damage are visible, which may weaken the structure or cause electrical hazards.', 'Identify and fix the source of the leak, and have the affected area assessed for structural integrity.'),
    ('gas_tank',                'fire',       'critical', 'A gas tank is improperly stored or unsecured, posing a significant fire or explosion risk.', 'Store gas tanks upright in a well-ventilated area, away from ignition sources, and ensure they are securely fastened.');