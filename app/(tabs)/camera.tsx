  ...
  if (!permission.granted) {
    return (
      <View className="flex-1 justify-center items-center bg-surface-default px-8">
        <Text className="text-center font-text font-bold text-lg mb-6 text-text-primary">
      ...
      <CameraView style={{ flex: 1 }} facing="back">
        ...
        {showNotification && (
          <View className="absolute top-8 w-full items-center z-50">
            <View className="bg-white rounded-[16px] pl-10 pr-6 py-3 flex-row items-center border border-gray-100 shadow-lg ml-6">
              {/* Mascot Bubble */}
              <View className="absolute -left-8 -top-3 w-[64px] h-[64px] rounded-full bg-[#bde0fe] items-center justify-center shadow-sm overflow-hidden">
                <Image
              ...
              <Text className="font-text text-[15px] font-medium text-text-primary ml-2">
